...
import com.example.necromod.item.CustomCreativeTab;
...
public class Necromod
{
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        if (event.getTabKey() == CreativeModeTabs.BUILDING_BLOCKS)
            ...
            event.accept(CustomBlocks.ETHERIUM_ORE.get().asItem());
        event.accept(CustomBlocks.ETHERIUM_BLOCK.get().asItem());
        event.accept(CustomBlocks.DEEPSLATE_ETHERIUM_ORE.get().asItem());
